...
public class Hedgehog { //This defines a new class "hedgehog", which is like a template from which you can create multiple "hedgehogs"
    ...
    private String siilinika; //These variable store the hedgehog's name and age. Private means that these variables can only be accessed from within this class 

    public Hedgehog(String siilinnimi, String string) { //This is the constructor. When a new Hedgehog object is created, 
        ...
        this.siilinika = string; // Stores information about the hedgehog
    }
