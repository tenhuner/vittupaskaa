...
public class Hedgehog { //This defines a new class "hedgehog", which is like a template from which you can create multiple "hedgehogs"
    private String siilinnimi; //These variables store the hedgehog's name and age. Private means that these variables can only be accessed from within this class 
    private String siilinika; //These variables store the hedgehog's name and age. Private means that these variables can only be accessed from within this class 

    public Hedgehog(String siilinnimi, String siilinika) { //This is the constructor. When a new Hedgehog object is created, 
    ...
    public String getika() { //This method returns the age of the hedgehog. 
        return siilinika;
    }
}
